...
class Application:
    ...
    def __init__(self):
        ...
        self._dispatch_dict: list[tuple[Sequence[type[Event]], Sequence[Any], Callable[["Node", Event], bool | None]]] = []
    ...
    def add_handler(
        ...
        Args:
            handler: The handler to process the event.
                It is an object method that accepts a Node (or its subclass) and the event.
